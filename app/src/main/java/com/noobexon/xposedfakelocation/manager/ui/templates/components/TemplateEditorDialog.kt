    ...
    AlertDialog(
        ...
        text = {
            Column(
                ...
                OverrideStateSelector("Randomize Nearby Location", randomizeOverride) {
                ...
                OverrideStateSelector("GPS noise", gpsNoiseOverride) {
                    gpsNoiseOverride = it
                ...
                OverrideStateSelector("Custom Horizontal Accuracy", accuracyOverride) {
                    accuracyOverride = it
                ...
                OverrideStateSelector("Custom Vertical Accuracy", verticalAccuracyOverride) {
                ...
                OverrideStateSelector("Custom Altitude", altitudeOverride) {
                    altitudeOverride = it
                ...
                OverrideStateSelector("Custom MSL", meanSeaLevelOverride) {
                ...
                OverrideStateSelector("Custom MSL Accuracy", meanSeaLevelAccuracyOverride) {
                ...
                OverrideStateSelector("Custom Speed", speedOverride) {
                    speedOverride = it
                ...
                OverrideStateSelector("Custom Speed Accuracy", speedAccuracyOverride) {
